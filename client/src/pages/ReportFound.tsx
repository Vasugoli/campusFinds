...
const ReportFound = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar />
      <div className="flex-1 py-12 bg-gradient-to-b from-secondary/5 to-background">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    id="title"
                    placeholder="e.g., iPhone with Red Case"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="location"
                    placeholder="e.g., Student Center Cafeteria, Table 5"
